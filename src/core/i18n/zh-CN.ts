...
Object.assign(zhCNRuntimeUi, {
  ...
  'base.back': '返回', 'base.day': '第 {day} 天', 'base.coreHp': '核心:{hp}/{maxHp}', 'base.night': '迎接夜晚', 'base.blackMarket': '黑市', 'base.marketStars': '星星：{star}', 'base.marketWallet': '星星：{star}  钻石：{diamond}', 'base.marketExchange': '1钻石 = 100金币', 'base.marketExchanged': '已兑换 100 金币', 'base.marketPrice': '{star} 星星', 'base.marketComplete': '完整蓝图', 'base.marketBought': '已购入 {building} 蓝图', 'base.marketMaterials': '急缺材料 · 星星直购', 'base.marketBlueprints': '蓝图', 'base.marketNeedQty': '订单需要 ×{num}', 'base.marketMaterialBought': '已购入 {item}', 'base.recommendedCounter': '推荐应对', 'base.recommendedCounterBody': '建议在黑市直接购入 {building} 的完整蓝图。', 'base.none': '无', 'base.resourceGain': '资源建筑产出：{gain}',
