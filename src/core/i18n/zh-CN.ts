...
export const zhCNRuntimeUi: Record<string, string> = { ...zhCNCommonUi,
  ...
  'toast.mergeNeedsCore': '需要「{core}」才能合成这类物品',
  ...
  'toast.coreResonance': '合成核心共鸣：产出升级！',
  'toast.coreGifted': '外婆留下的合成核心基座已发放',
  'toast.coreMigrated': '合成核心已并入基地核心（Lv.{level}）',
  'toast.nightStarts': '夜幕降临，保留当前行动力', 'toast.waveIncoming': '第 {wave}/{total} 波僵尸来袭！', 'toast.daybreakLoot': '天亮了！战利品：{loot}', 'toast.taskRelief': '订单卡住了？小满翻出些压箱底的物资：{item} ×{num}',
  ...
  'toast.buildingNotBuildable': '该建筑不可建造', 'toast.buildingLocked': '未解锁：合成 {blueprint} 后解锁', 'toast.outOfBase': '超出基地范围', 'toast.cellOccupied': '该格已有建筑', 'toast.expandTerritory': '请先扩张到该格子', 'toast.killCorridor': '必须保留一条敌人引流走廊', 'toast.onlyTowers': '现在只能建造炮塔', 'toast.outerCityOnly': '炮塔只能建在外城（内城 9×9 用来合成）', 'toast.corridorSealed': '注意：这条敌人通路被封死了，僵尸会改为就地拆墙／踩碎挡路棋子', 'toast.itemCrushed': '{item}被僵尸踩碎了：在相邻格合成一次即可重新翻开', 'toast.notEnoughCoinsBuild': '金币不足：需要 {coins} 金币，当前 {have}，可在黑市出售材料换取',
  'terrain.grass': '杂草丛', 'terrain.rubble': '瓦砾堆', 'terrain.shack': '破旧建筑', 'terrain.woods': '树林', 'terrain.pond': '水池',
  'terrain.clearTitle': '清理地形', 'terrain.clearAction': '清理（{coins} 金币）', 'terrain.hint.grass': '长满杂草的空地，清理后可用于建造。',
  'terrain.hint.rubble': '坍塌建筑的瓦砾，挡住僵尸去路，清理后可建造。',
  'terrain.hint.shack': '还能挡一挡僵尸的破房子，清理后可建造。',
  'terrain.hint.woods': '枯树林，僵尸穿行其中会拖慢脚步，清理后可建造。',
  'terrain.hint.pond': '积水池塘，地面僵尸无法通过（飞行除外），填平后可建造。',
  'toast.terrainBlocked': '需先清理{terrain}', 'toast.terrainCleared': '已清理{terrain}（-{coins} 金币）', 'toast.notEnoughCoinsClear': '金币不足：清理需要 {coins} 金币，可在黑市出售材料换取',
...
Object.assign(zhCNRuntimeUi, {
  ...
  'action.popBubble': '戳破气泡 {cost}钻', 'action.skipCooldown': '跳过CD', 'action.view': '查看', 'action.intro': '简介', 'action.use': '使用', 'action.convertFuel': '转化燃料', 'action.sell': '出售 {price}金币',
  'core.intro.title': '合成核心',
  'core.tier.0': '普通物品',
  'core.tier.1': '普通 + 钢铁物品',
  'core.tier.2': '普通 + 钢铁 + 高科技物品',
  'core.baseName': '基地核心',
  'core.card.title': '{name} Lv.{level}',
  'core.card.ready': '库存 {times}/{max} · 核心光环 {aura}% · 再次点击发射',
  'core.card.cooling': '库存耗尽，冷却 {time} · 长按查看面板',
  'core.card.panel': '核心',
  'core.panel.title': '基地核心',
  'core.panel.name': '{name}  Lv.{level}',
  'core.panel.stock': '发射库存',
  'core.panel.cooldown': '冷却',
  'core.panel.ready': '就绪',
  'core.panel.aura': '核心光环',
  'core.panel.tier': '可合成档次',
  'core.panel.upgradeCost': '升级材料',
  'core.panel.upgrade': '升级核心',
  'core.panel.maxLevel': '已满级',
  'core.panel.upgradeHint': '材料来自夜战掉落：神秘零件 ×1、核心残片 ×2（按当量计算）',
  'core.panel.repair': '修复核心',
  'core.panel.body': '点击核心发射各链初始材料（每次 1 体力，库存耗尽后等冷却回满）。核心光环提升全场发射器产出。',
  'core.productsTitle': '基地核心 Lv.{level} · 产出一览',
  'core.productsHint': '升级核心可解锁更多链首材料 · 点击空白处关闭',
  'core.upgraded': '基地核心升至 Lv.{level}',
  'core.upgradeMaxed': '基地核心已满级',
  'core.upgradeNeedMaterial': '核心材料不足（需要 {cost} 当量）',
  'guide.tag': '引导', 'guide.merge': '拖动两个相同物品合成', 'guide.coreSpawn': '点击基地正中央的核心，发射两个工具箱把手', 'guide.spawn': '点击发光物品产出新物品', 'guide.collect': '继续合成，收集任务物品', 'guide.submit': '点击任务条提交任务获得星星',
  'guide.emitter': '点两下左下箭塔蓝图箱，免费产出碎片', 'guide.blueprintMerge': '合成两个蓝图碎片，逐级得到箭塔蓝图', 'guide.unlockTower': '选中完整箭塔蓝图，再点「使用」解锁箭塔',
  'guide.buildTower': '金币够了！在下方建造栏盖箭塔，守住东边缺口', 'guide.towerCost': '盖箭塔要 {cost} 金币，现在只有 {have}：先完成任务或卖材料赚钱', 'guide.powerEmitter': '箭塔缺电了！点两下电站蓝图箱，免费产出碎片', 'guide.powerBlueprintMerge': '合成两个蓝图碎片，逐级得到电站蓝图', 'guide.unlockGenerator': '选中完整电站蓝图，再点「使用」解锁发电机',
  'guide.buildGenerator': '金币够了！在下方建造栏盖风力发电站，为阵地接通稳定电力', 'guide.generatorCost': '盖风力发电站要 {cost} 金币，现在只有 {have}：先完成任务或卖材料赚钱',
  ...
  'task.diamondComplete': '{cost} 钻直接完成',
...
Object.assign(zhCNRuntimeUi, {
  ...
  'base.back': '返回', 'base.day': '第 {day} 天', 'base.coreHp': '核心:{hp}/{maxHp}', 'base.night': '迎接夜晚', 'base.routeOn': '路线：开', 'base.routeOff': '路线：关', 'base.blackMarket': '黑市', 'base.marketStars': '星星：{star}', 'base.marketWallet': '星星：{star}  钻石：{diamond}', 'base.marketExchange': '1钻石 = 100金币', 'base.marketExchanged': '已兑换 100 金币', 'base.marketPrice': '{star} 星星', 'base.marketComplete': '完整蓝图', 'base.marketBought': '已购入 {building} 蓝图', 'base.marketMaterials': '急缺材料 · 星星直购', 'base.marketBlueprints': '蓝图', 'base.marketNeedQty': '订单需要 ×{num}', 'base.marketMaterialBought': '已购入 {item}', 'base.recommendedCounter': '推荐应对', 'base.recommendedCounterBody': '建议在黑市直接购入 {building} 的完整蓝图。', 'base.none': '无', 'base.resourceGain': '资源建筑产出：{gain}',
  'base.heroJoined': '{hero} 加入了堡垒！可在基地『英雄』页部署，协助防守内圈。', 'base.noPower': '缺电', 'base.antiAir': '对空', 'base.buildCancel': '再点一次建筑按钮取消摆放',
  ...
  'base.buildingDesc.101': '对地射击；需雷达覆盖后才能对空。', 'base.buildingDesc.102': '重型炮弹轰击落点及周围1格敌人，射速较慢，可对空。', 'base.buildingDesc.103': '无视护甲并连锁多名敌人，可对空。', 'base.buildingDesc.104': '减速范围内敌人，可攻击飞行敌人。',
  ...
  'base.buildingDesc.301': '踩过的地面敌人持续受伤，不能对空。', 'base.buildingDesc.302': '敌人踩中爆炸后消失，不能对空。', 'base.buildingDesc.303': '大幅减速踩过的地面敌人，每减速一只损耗 1 点耐久，不能对空。',
  ...
  'base.buildingLocked': '「{building}」未解锁：合成 {blueprint}碎片可获得{blueprint}', 'base.notEnoughCoins': '金币不足：需要 {coins} 金币，当前 {have}，可在黑市出售材料换取',
...
Object.assign(zhCNRuntimeUi, {
  'account.title': '账号',
  'account.hint': '登录后进度自动同步到云端，换设备、清缓存都不丢档。',
  'account.guestRow': '游客 · 点击登录绑定进度',
  'account.email': '邮箱',
  'account.password': '密码',
  'account.emailPlaceholder': '输入邮箱',
  'account.passwordPlaceholder': '输入密码',
  'account.signIn': '登录',
  'account.signUp': '注册',
  'account.forgot': '忘记密码',
  'account.signingIn': '请稍候…',
  'account.loggedInAs': '当前账号',
  'account.syncNow': '立即同步',
  'account.signOut': '退出登录',
  'account.bound': '进度已绑定到账号',
  'account.syncDone': '已同步到云端',
  'account.syncFail': '同步失败，下次存档时会自动重试',
  'account.signupConfirmSent': '注册成功！请查收验证邮件，点击链接完成验证后再登录',
  'account.resetSent': '重置密码邮件已发送，请按邮件提示操作',
  'account.conflict.title': '存档冲突',
  'account.conflict.body': '这个账号的云端和本机各有一份不同的进度，请选择要保留的一份：',
  'account.conflict.cloud': '云端进度\n第 {day} 天 · {time}',
  'account.conflict.local': '本机进度\n第 {day} 天 · {time}',
  'account.conflict.later': '稍后再说',
  'account.error.noEmail': '请输入邮箱',
  'account.error.noPassword': '请输入密码',
  'account.error.invalidEmail': '邮箱格式不正确',
  'account.error.invalidCredentials': '邮箱或密码错误',
  'account.error.emailNotConfirmed': '邮箱尚未验证，请先查收验证邮件',
  'account.error.emailTaken': '该邮箱已注册，请直接登录',
  'account.error.weakPassword': '密码至少 6 位',
  'account.error.rateLimit': '操作太频繁，请稍后再试',
  'account.error.generic': '操作失败，请检查网络后重试'
});
