...
export const zhCNRuntimeUi: Record<string, string> = { ...zhCNCommonUi,
  ...
  'toast.buildingNotBuildable': '该建筑不可建造', 'toast.buildingLocked': '未解锁：合成 {blueprint} 后解锁', 'toast.outOfBase': '超出基地范围', 'toast.cellOccupied': '该格已有建筑', 'toast.expandTerritory': '请先扩张到该格子', 'toast.killCorridor': '必须保留一条敌人引流走廊', 'toast.notEnoughCoinsBuild': '金币不足：需要 {coins} 金币，当前 {have}，可在黑市出售材料换取',
