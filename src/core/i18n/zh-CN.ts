...
Object.assign(zhCNRuntimeUi, {
  ...
  'guide.buildTower': '金币够了！在下方建造栏盖箭塔，守住东边缺口', 'guide.towerCost': '盖箭塔要 {cost} 金币，先完成任务赚钱', 'guide.powerEmitter': '箭塔缺电了！点两下电站蓝图箱，免费产出碎片', 'guide.powerBlueprintMerge': '合成两个蓝图碎片，逐级得到电站蓝图', 'guide.unlockGenerator': '选中完整电站蓝图，再点「使用」解锁发电机',
  'guide.buildGenerator': '金币够了！在下方建造栏盖风力发电站，为阵地接通稳定电力', 'guide.generatorCost': '盖风力发电站要 {cost} 金币，先完成任务赚钱',
