...
export const zhCNRuntimeUi: Record<string, string> = { ...zhCNCommonUi,
  ...
  'toast.buildingNotBuildable': '该建筑不可建造', 'toast.buildingLocked': '未解锁：合成 {blueprint} 后解锁', 'toast.outOfBase': '超出基地范围', 'toast.cellOccupied': '该格已有建筑', 'toast.expandTerritory': '请先扩张到该格子', 'toast.killCorridor': '必须保留一条敌人引流走廊', 'toast.corridorSealed': '注意：这条敌人通路被封死了，僵尸会改为就地拆墙／踩碎挡路棋子', 'toast.itemCrushed': '{item}被僵尸踩碎了：在相邻格合成一次即可重新翻开', 'toast.notEnoughCoinsBuild': '金币不足：需要 {coins} 金币，当前 {have}，可在黑市出售材料换取',
