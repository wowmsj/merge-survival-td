...
Object.assign(zhCNRuntimeUi, {
  ...
  'core.intro.inactive': '尚未激活（需要核心基座）',
  'core.intro.status': '光环 {aura}% · 可合成：{tierName}',
  'core.tier.0': '普通物品',
  'core.tier.1': '普通 + 钢铁物品',
  'core.tier.2': '普通 + 钢铁 + 高科技物品',
  'core.intro.body': '外婆留下的装置，堡垒真正的中枢。\n· 核心发射：选中后再次点击，可发射各类发射器链的初始材料（工具箱把手、旧保温箱、种子等），每次消耗 1 体力；核心等级越高，可发射的品类越多、库存越大，高等级核心还有概率直接产出 2 级材料。\n· 核心光环：放在棋盘上，全场发射器和收集站的产出有概率直接升一级，核心等级越高共鸣越强。\n· 合成权限：普通物品随时可合；钢铁物品（废铁、防御材料、机器人等）需要「合成核心原型」；高科技物品（无线电、芯片等）需要「合成核心·二型」。\n· 升级方式：夜战精英和 Boss 保底掉落「神秘零件」，两个相同核心部件合成下一级，一路升到「完整合成核心」。',
  'guide.tag': '引导', 'guide.merge': '拖动两个相同物品合成', 'guide.coreSpawn': '点击合成核心，发射两个工具箱把手', 'guide.spawn': '点击发光物品产出新物品', 'guide.collect': '继续合成，收集任务物品', 'guide.submit': '点击任务条提交任务获得星星',
