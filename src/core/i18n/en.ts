...
Object.assign(enRuntimeUi, {
  ...
  'guide.buildTower': 'Enough Coins. Build an Arrow Tower from the build bar below to guard the eastern breach.', 'guide.towerCost': 'The Arrow Tower costs {cost} Coins. Complete a task first.', 'guide.powerEmitter': 'The Arrow Tower has no power. Tap the power-station blueprint box twice for free fragments.', 'guide.powerBlueprintMerge': 'Merge blueprint fragments into a power-station blueprint.', 'guide.unlockGenerator': 'Select the full blueprint, then tap Use to unlock the generator.',
  'guide.buildGenerator': 'Enough Coins. Build the Wind Power Station from the build bar below to bring the grid online.', 'guide.generatorCost': 'The Wind Power Station costs {cost} Coins. Complete a task first.',
