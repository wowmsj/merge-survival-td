...
Object.assign(enRuntimeUi, {
  ...
  'core.intro.inactive': 'Not activated (needs Core Base)',
  'core.intro.status': 'Aura {aura}% · Mergeable: {tierName}',
  'core.tier.0': 'Common items',
  'core.tier.1': 'Common + Steel items',
  'core.tier.2': 'Common + Steel + Hi-tech items',
  'core.intro.body': "Grandma's device — the true heart of the fortress.\n· Core Emission: select it, then tap again to emit base materials for spawner chains (Toolbox Handle, Old Cooler, seeds, etc.). Each tap costs 1 Energy. Higher core levels unlock more categories, hold more charges, and can directly output Lv.2 materials.\n· Core Aura: while on the board, all spawners and the Collection Station have a chance to output upgraded items. Higher core levels resonate stronger.\n· Merge Permission: common items anytime; steel items (scrap iron, defense materials, robots) need the Merge Core Prototype; hi-tech items (radio, chips) need Merge Core Mk. II.\n· How to upgrade: night elites and bosses always drop Mysterious Parts. Merge two identical core parts to reach the next level, all the way to the Complete Merge Core.",
  'guide.tag': 'Guide', 'guide.merge': 'Drag matching items together to merge.', 'guide.coreSpawn': 'Tap the Merge Core to emit two Toolbox Handles.', 'guide.spawn': 'Tap the glowing item to produce one.', 'guide.collect': 'Keep merging to collect task items.', 'guide.submit': 'Tap a task to submit it for Stars.',
