...
export const enRuntimeUi: Record<string, string> = { ...enCommonUi,
  ...
  'toast.buildingNotBuildable': 'This building cannot be placed.', 'toast.buildingLocked': 'Locked: merge {blueprint} to unlock it.', 'toast.outOfBase': 'Outside the base.', 'toast.cellOccupied': 'This cell already has a building.', 'toast.expandTerritory': 'Expand to this cell first.', 'toast.killCorridor': 'Keep an open path for enemies.', 'toast.notEnoughCoinsBuild': 'Not enough Coins: {coins} needed (you have {have}). Sell materials on the black market.',
